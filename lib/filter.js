...
exports.parseFilter = (filter) => {
  ...
  if (filter.hasOwnProperty('matchMissing') && !(typeof filter.matchMissing === 'boolean')) {
    throw new Error('`matchMissing` must be a boolean');    
  }

  if (filter.hasOwnProperty('matchEmpty') && !(typeof filter.matchMissing === 'boolean')) {
    throw new Error('`matchEmpty` must be a boolean');
  }
